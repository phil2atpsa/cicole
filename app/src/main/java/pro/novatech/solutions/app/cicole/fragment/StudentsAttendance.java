...
import pro.novatech.solutions.app.cicole.adapter.StudentAttendancesDataAdapter;
...
public class StudentsAttendance extends Fragment  {
    ...
    private StudentAttendancesDataAdapter adapter;
    ...
    private  void initViews(){
        ...
        new Teacher(getActivity(), new OnServiceResponseListener() {
            ...
            public void onSuccess(Object object) {
                ...
                adapter = new StudentAttendancesDataAdapter(studentResponses, getActivity());
